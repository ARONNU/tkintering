...
def display_attendance(data):
    for index, row in enumerate(data, start=1):
        name_label = tk.Label(attendance_frame, text=row['Name'], bg='#FFFFFF', fg='#000000', padx=20, pady=10)
        type_label = tk.Label(attendance_frame, text=row['Type'], bg='#FFFFFF', fg='#000000', padx=20, pady=10)
        date_label = tk.Label(attendance_frame, text=row['Date'], bg='#FFFFFF', fg='#000000', padx=20, pady=10)
        time_label = tk.Label(attendance_frame, text=row['Time'], bg='#FFFFFF', fg='#000000', padx=20, pady=10)
    ...
    plt.title('Attendance Types', fontsize=12, fontweight='bold', color='#CC3333')
    ...
    date_label = tk.Label(date_time_frame, text=f'Current Date: {current_date}', font=('Arial', 16, 'bold'), bg='#FF6666', fg='#000000', padx=20, pady=10)
    time_label = tk.Label(date_time_frame, text=f'Current Time: {current_time}', font=('Arial', 16, 'bold'), bg='#FF6666', fg='#000000', padx=20, pady=10)
...
date_time_frame = tk.Frame(window, bg='#FF6666', pady=10)
